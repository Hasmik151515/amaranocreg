...
export default function Login({ onLogin }) {
  ...
  return (
    <div>
      ...
      {error && <p className="relative top-[140px] left-[480px] text-red-500">{error}</p>}

      <p className="relative top-[150px] left-[480px] text-[13px] font-medium">Forgot password</p>
      <button
        onClick={handleLogin}
      ...
      <p className="relative top-[250px] left-[620px]">
        Not registered yet <span className="absolute left-[132px] text-orange-400">Register</span>
      </p>
    </div>
  );
}

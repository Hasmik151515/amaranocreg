    ...
    <div>
      ...
      <div>
        <input
          ...
          className="relative top-[100px] left-[470px] p-5 border border-blue-500 rounded-[10px] h-[43px] w-[480px]"
        />
      </div>
      <div>
        <input
          ...
          className="relative top-[120px] left-[470px] p-5 border border-blue-500 rounded-[10px] h-[43px] w-[480px]"
        />
      </div>

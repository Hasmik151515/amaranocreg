...
const PriceFilter = () => (
  <div className="price-filter">
    ...
    <div className=" absolute top-[395px] left-[200px] border border-1-blue rounded-full h-9 w-9 flex font-medium justify-center items-center bg-black 	text-white">Դ</div>
